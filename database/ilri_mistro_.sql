...
--
-- Host: localhost
-- Generation Time: Nov 19, 2013 at 10:04 AM
...
CREATE TABLE IF NOT EXISTS `cow` (
  ...
  `age_type` enum('Years','Months','Days') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cow_event` (
  ...
  `date_added` datetime NOT NULL,
  `birth_type` enum('Normal','Still','Premature','Abortion') DEFAULT NULL,
  ...
  `no_of_live_births` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `milk_production` (
  ...
  `milking_per_day` int(11) NOT NULL DEFAULT '0',
  `calf_suckling` enum('Yes','No') NOT NULL,
  PRIMARY KEY (`id`),
